...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2017 at 12:16 PM
...
INSERT INTO `daily_plan` (`daily_plan`, `country_id`, `island_id`, `per_day_amount`) VALUES
(1, 3, 1, 600.00),
(2, 3, 2, 300.00),
(3, 2, 4, 400.00),
(4, 2, 3, 500.00);
...
(1, 'Asia Diving Vacation', 'abc 3rd Floor, Block C', 'Damai Plaza IV 88300', 'Kota Kinabalu', '', 3, 2, 'adam', 6023356988, 'adam@g.com', '2.jpg'),
...
INSERT INTO `special_offer` (`special_offer_id`, `offer_image`, `country_id`, `island_id`, `offer_period`, `price`, `starting_place_id`, `destination_place_id`, `start_km`, `note`) VALUES
(1, '1.jpg', 3, 4, 'Feb 25th', 4500.00, 3, 4, '1200', '<p><strong>special offer dive center.</strong></p>\r\n'),
(2, '2.jpg', 2, 3, 'mar 15th', 2500.00, 2, 3, '1700000', 'sdhkfdsbdfdfbdkbfkdf, kdsbfkdbks'),
(3, '3.jpg', 2, 1, 'feb 5', 1800.00, 3, 2, '2500000', 'dsndsfmds'),
(4, '4.jpg', 3, 2, 'mar 5', 600.00, 3, 3, '25000', 'bjdsdsdksdbsd');
...
INSERT INTO `tbl_social_links` (`id`, `name`, `links`) VALUES
(1, 'twitter', '#'),
(2, 'pinterest', '#'),
(3, 'facebook', '#'),
(4, 'google-plus', '#'),
...
(33, '123', 'SUPERADMIN', 'sadmin', 'TRUE', '2017-02-20 03:16:38', 'Super Admin', '', '', 8),
...
--
ALTER TABLE `daily_plan`
  MODIFY `daily_plan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
