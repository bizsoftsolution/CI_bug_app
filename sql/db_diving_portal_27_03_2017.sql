...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2017 at 01:23 PM
...
CREATE TABLE `tbl_dccourses` (
  ...
  `product_description` text NOT NULL,
  `product_includes` varchar(100) NOT NULL,
  `product_excludes` varchar(100) NOT NULL,
  `common_options` text NOT NULL,
  `other_info` varchar(255) DEFAULT NULL,
  `product_category` varchar(100) NOT NULL,
  `product_keyword` varchar(100) NOT NULL,
  `sequence_number` int(20) NOT NULL,
  `product_status` varchar(100) NOT NULL,
  `product_unit` varchar(100) NOT NULL,
  `max_dive_day` int(20) NOT NULL,
  `product_max_day` int(20) NOT NULL,
  `product_price` double(18,2) NOT NULL,
  `discount_bulk_purchase` varchar(50) NOT NULL,
  `discount_unit` varchar(50) NOT NULL,
  `range_start` int(11) NOT NULL,
  `range_end` int(11) NOT NULL,
  `discount_rate` int(20) NOT NULL,
  `apply_promo` varchar(50) NOT NULL,
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `ap_discount_unit` varchar(50) NOT NULL,
  `ap_discount_rate` int(20) NOT NULL,
  `apply_promo_bilk_discount` varchar(20) NOT NULL,
  `optional_services` text NOT NULL,
  `diver_certification` varchar(255) NOT NULL,
  `diver_experience` varchar(255) NOT NULL,
  `diver_specialties` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbl_dcguidedtours` (
  ...
  `twin_room` text NOT NULL,
  `three_person_room` text NOT NULL,
  `quad_room` text NOT NULL,
  `discount_bulk_purchase` varchar(50) NOT NULL,
  `discount_unit` varchar(50) NOT NULL,
  `range_start` int(11) NOT NULL,
  `range_end` int(11) NOT NULL,
  ...
  `oneperson_bed_type` varchar(255) NOT NULL,
  `twoperson_bed_type` varchar(255) NOT NULL,
  `threeperson_bed_type` varchar(255) NOT NULL,
  `fourperson_bed_type` varchar(255) NOT NULL,
  ...
  `gpsx` varchar(100) NOT NULL,
  `gpsy` varchar(100) NOT NULL,
  `dive_sites` varchar(255) NOT NULL,
...
CREATE TABLE `tbl_dcleisure` (
  ...
  `product_max_day` varchar(255) NOT NULL,
  `product_price` double(18,2) NOT NULL,
  `discount_bulk_purchase` varchar(50) NOT NULL,
...
(2, 'Snorkelling', 'Go on a Snorkelling Excursion around Pulau Tioman. We’ll take you to the 5 of the most beautiful sites where you can play and swim among the fishes.', 'Snorkel & Mask + Safety Vest is provided.', 'Marine Park Fee', NULL, 'There will be a lunch break. This is a full day event.', 'Leisure Dive', 'Dive Packages', 2, 'Available', 'Pax', 0, 'No Limit', 200.00, 'Yes', '$', 3, 4, 10, 'No', '0000-00-00', '0000-00-00', '', 0, NULL, ',', 'Non-Diver', '', ''),
...
(4, 'GoPro Rental', 'Underwater GoPro Camera Rental', 'Rental for 1 day', 'N/A', '', 'A separate refundable deposit of MYR 200 is required.', 'Leisure Dive', '', 4, 'Available', 'Day', 0, 'No Limit', 200.00, 'No', NULL, 0, 0, 0, 'No', '0000-00-00', '0000-00-00', NULL, 0, NULL, '', 'Non-Diver', '', '');
...
CREATE TABLE `tbl_dcpackage` (
  ...
  `product_unit` varchar(100) NOT NULL,
  `product_max_day` int(20) NOT NULL,
  `normal_product_price` double(18,2) NOT NULL,
  `weekend_product_price` double(18,2) NOT NULL,
  `peak_product_price` double(18,2) NOT NULL,
  `disaccomodation` varchar(250) NOT NULL,
  `single_room` text NOT NULL,
  `twin_room` text NOT NULL,
  `three_person_room` text NOT NULL,
  `quad_room` text NOT NULL,
...
(1, 'Tioman Dive Center', 'Image_A.jpg', 'We are located in Pulau Tioman, a 5 minute walk from Kampung ABC jetty. We cater to all diving and snorkelling activities around this area. We are staff by our friendly Dive Instructor Justin and other dive instructors. Dive with us to marvel in the abundant marine life and experience an unforgettable moment with us.', 3, 2, '123123', '123123', 'Tioman Dive Sdn Bhd', '123456-X', '012-1234567', 'No. 12, Jalan 12, Rompin, Pahang, Malaysia', '06-12345678', '5, Jalan Batu, Kampung ABC, Pulau Tioman', '016-1234567', '-', 'admin@demo.com', 'www.tdc.com.my', '4', 2, '20', 'CLASSROOM,WASH CABIN,SHOWER,', 'SSI,PADI', '12345-S, 34566-I', 'MARCH,APRIL,JUNE,JULY,AUGUST,SEPTEMBER,OCTOBER', 'ENGLISH,FRENCH,Malay', 'CERTIFICATION CARD,LOGBOOK,', 'MYR', 33);
...
(33, '123', 'SUPERADMIN', 'sadmin', 'TRUE', '2017-03-27 12:22:34', 'Super Admin', '', '', 8),
