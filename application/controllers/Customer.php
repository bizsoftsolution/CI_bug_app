...
//		$this->load->library('session');
	   ...
	   public function individualMessage($diveId)
	   {
		   $this->load->view('front/header');
			$user_id = $this->session->userdata('user_id');
			$result['oldConversation']= $this->Customermodel->individualMessage($user_id,$diveId);
...
function customerWritemyreview()
	{
		$this->load->view('front/header');
		$this->load->view('front/customer_writeMyreview');
		//$this->load->view('front/footer');
	}
