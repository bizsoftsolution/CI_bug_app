												...
												<div class="item">
													<div class="grid-item-inner">
														<div class="grid-img-thumb">
															...
															<a href="#"><img src="<?php echo base_url();?>upload/specialoffer/<?php echo $offer->offer_image; ?>" alt="1" class="img-responsive" height="370" width="370"/></a>
														</div>
														<div class="grid-content">
															<div class="grid-price text-right">
																From Rp.1700000 <span><sub>Dive</sub>2</span>
															</div>
															<div class="grid-text">
																<div class="place-name">Pulau Weh, Indonesia </div>
																<div class="travel-times">
																	<h4 class="pull-left">ABC Dive Center</h4>
