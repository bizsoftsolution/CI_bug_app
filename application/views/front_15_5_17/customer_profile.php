<!-- mobile-menu-area-end -->
         ...
         <section class="dashboard light-blue">
            <div class="container">
			   ...
			   <?php 
								foreach($get_customerprofile as $row)
								{
								?>
					 ...
					 <div class="col-md-12 col-sm-5 col-xs-12">
							<h4 align="center" style="font-weight:bold;text-decoration:underline"><a href="<?php echo base_url('Front/customereditProfile'); ?>/<?php echo $row->id;?>">EDIT MY PROFILE</a></h4>
							<p align="center" style="font-weight:bold;text-decoration:underline"><a href="<?php echo base_url('Front/customerChangepassword'); ?>/<?php echo $row->id;?>">CHANGE MY PASSWORD</a></p>
					   </div>
                  </div>
