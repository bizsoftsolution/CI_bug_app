                    ...
                    <div class="flate-search" style="background-color:#f4f7fa ;">
                            ...
                            <div class="col-md-3 col-sm-2 col-xs-12 nopadding">
                                <div class="form-group">
                                    ...
                                    <div class="form-group" id="">
                                        <input type="number" class="form-control col-md-5" name="no_of_persons" placeholder="Check Out" value="1" style="width:70px;" id="num1"/>
                                        <label class="col-md-7" style="color:#000;font-size:16px">No of Persons</label>
                                    </div>
                                </div>
                            </div>
							 <div class="col-md-1 col-sm-2 col-xs-12 nopadding">
								<input type="submit" class="btn btn-default btn-search-submit fa fa-search" value="Search" name="search_result" style="height:30px;">
							 </div>
                        ...
                        <div style="padding-bottom:20px;padding-top:10px;">
                            ...
                            <div class="col-md-6" style="text-align:right;">
                                <?php echo $total_records; ?> Dive Centers
                            </div>
                        </div>
                    </div>
                    <br>
				...
				?>
                        ...
                        <div class="col-md-6">
                            <div class="row" style="border: 3px solid #000;margin:1px;">
                                    ...
                                    <!-- wrapper for slides -->
                                     <div class="carousel-inner" role="listbox">
                                        ...
                                        <div class="item active">
                                            <img src="<?php echo base_url();?>assets/frontend/assert/images/2s.jpg" alt="Chania">
                                        </div>
                                ...
                                <a target="_blank" href="<?php echo base_url(); ?>Front/divecenter">
					...
					<div class="row">
						<div class="col-md-12">
							<?php echo $page; ?> - <?php echo $per_page; ?> of <?php echo $total_records; ?> Dive Center
							<nav aria-label="...">
							   <?php echo $links; ?>
							</nav>
						</div>
