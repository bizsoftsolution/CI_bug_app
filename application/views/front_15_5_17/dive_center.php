							...
							<div class="modal-content" style="width: 60%;">
								...
								<div class="modal-body">
									...
									<form role="form">
									  ...
									  <!--input type="submit" class="btn btn-danger" style="width:100%;" value="Login"-->
									   <a  href="<?php echo base_url('Front/customerDashboard'); ?>" type="submit" class="btn btn-danger" style="width:100%;">Log in</a>
									  <hr style="width:100%;">
									  <!--div class="form-group">
								...
								<div class="modal-footer">
									<div class="row">
										...
										<div class="col-md-6"> <a  href="<?php echo base_url('Front/customerSignup'); ?>" type="submit" class="btn btn-danger" style="width:100%;background:#fff;color:red;">Sign up</a></div>
									</div>
						...
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-2 col-xs-12 nopadding">
									<div class="form-group">											 
										 <input type="text" id="date-range200" class="form-control" style="height: 50px;width:122px;"  name="checkin" value="">						 
									</div>
								</div>
								<div class="col-md-6 col-sm-2 col-xs-12 nopadding">
								   <div class="form-group">
										<input type="text" id="date-range201" class="form-control" style="height: 50px;width:122px;"  name="checkout" value="">
									</div>
								</div> 
								</span>
								</div>
...
// ]]></script>
		<div id="dvMap" style="width:420px; height: 750px;"></div>
              ...
              <div class="fixed affix-top" style="bottom: 0px;">
				...
				<div class="separator1"></div>
					...
					<button class="btn btn-success" data-toggle="modal" data-target="#myModalHorizontal">Checkout</button>
					</p>
					<p style="text-align:center">
