							...
							<div class="row">
								<div class="col-md-6">
									<label class="control-label col-md-3">Single Room</label>
									 <div class="col-md-6">
										<input name="single_room" class="form-control" type="text" required="" data-popup="tooltip" title="Single Room(It is required field)" data-placement="bottom">
									</div>
								...
								<div class="col-md-6">
									<label class="control-label col-md-3">Twin Room</label>
									 <div class="col-md-6">
										<input name="twin_room" class="form-control" type="text" required="" data-popup="tooltip" title="Twin Room(It is required field)" data-placement="bottom">
									</div>
									<div class="col-md-3"><span class="help-block">MYR / PAX</span></div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<label class="control-label col-md-3">3 Person Room</label>
									 <div class="col-md-6">
										<input name="three_person_room" class="form-control" type="text" required="" data-popup="tooltip" title="3 Person Room(It is required field)" data-placement="bottom">
									</div>
									<div class="col-md-3"><span class="help-block">MYR / PAX</span></div>
								</div>
								<div class="col-md-6">
									<label class="control-label col-md-3">Quad Room</label>
									 <div class="col-md-6">
										<input name="quad_room" class="form-control" type="text" required="" data-popup="tooltip" title="Quad Room(It is required field)" data-placement="bottom">
									</div>
									<div class="col-md-3"><span class="help-block">MYR / PAX</span></div>
								</div>
							</div>
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9">
							<div class="row">
								<div class="col-md-6">
									<input name="gpsx" class="form-control" type="text" placeholder="GPS COORDINATES X" data-popup="tooltip" title="Enter Latitude(It is required field)" data-placement="bottom" required>
									<span class="help-block"></span>
								</div>
								<div class="col-md-6">
									 <input name="gpsy" class="form-control" type="text" placeholder="GPS COORDINATES Y" data-popup="tooltip" title="Enter longitide(It is required field)" data-placement="bottom" required>
									<span class="help-block"></span>
								</div>
							</div>
                        </div>
