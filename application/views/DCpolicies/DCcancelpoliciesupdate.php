         ...
         <div class="container-fluid">
            ...
            <div class="col-md-10">
               ...
               <?php foreach($getEditdata as $row){?>
				...
				<hr>
				<form name="add" method="POST" action="<?php echo  base_url();?>DCpolicies/editCancellation/<?php echo $row->id; ?>" class="form-horizontal form-validate-jquery" 
					 ...
					 <div class="form-group">
						...
						<div class="col-md-12" style="background:whitesmoke;">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="col-md-6">								
										<input type="text" name="cancellation_amount[]" class="form-control" value="<?php echo $val003; ?>">
									</div>
									<div class="col-md-6">
