	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li class="active" ><a href="<?php echo base_url(); ?>Chat/inbox" >Inbox</a></li>
      ...
      <!-- Traffic sources -->
        ...
        <table class="table datatable-button-print-columns">
            ...
            ?>
              <tr>
              <td><a href="<?php echo base_url(); ?>Chat/new_chat/<?php echo $row->from;?>" ><?php echo $i; ?></a></td>
              <td><a href="<?php echo base_url(); ?>Chat/new_chat/<?php echo $row->from;?>" ><?php echo $row->from_name;?></a></td>
              <td><a href="<?php echo base_url(); ?>Chat/new_chat/<?php echo $row->from;?>" ><?php echo $row->message;?></a></td>
			  <?php  if ($row->is_read == 0){$status = "New";}else{$status = "Read";} ?>
              <td><a href="<?php echo base_url(); ?>Chat/new_chat/<?php echo $row->from;?>" ><?php echo $status;?></a></td>
              <td><a href="<?php echo base_url(); ?>Chat/new_chat/<?php echo $row->from;?>" ><?php echo $row->time;?></a></td>
