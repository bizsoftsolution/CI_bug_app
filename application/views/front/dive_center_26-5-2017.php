...
<html lang="en">
	...
	<body>
		...
		<body>
			...
			<div class="container-fluid" style="margin: 108px 0 0 0;">
				<div class="row">
					<div class="col-md-8">
						<?php
										...
										<div class="row">
											<table class="table" style="text-align: justify;font-family: initial;font-size: 15px;LINE-HEIGHT: 1.8;word-spacing: 1px;">
												...
												<tr>
													<td>Membership</td>
													<td>
													<?php echo str_replace(',', ', ', $divecenterval->dcaffiliation); ?>
													</td>
												</tr>
												<tr>
													<td>Languages</td>
																			...
																			<?php 
																				...
																				foreach($optional_services2 as $row_optional_price)
																				{
																					...
																					<p style="font-size: 12px;line-height: 20px;">
																						...
																						?>
																						<input type="checkbox" class="form-control1" class="optional_service_value[]" name="optional_service[]" value="<?php echo $con_string[$j]; ?>" data-productid="<?php echo " L- ".$cval21->id."- ".$j; ?>" data-productname="<?php echo $row_optional_name[$j]; ?>" data-price="<?php echo $row_optional_rate[$j]; ?>" />
																					</p>
																					<?php
																					$j++;
																				}
											...
											<?php
												...
												?>
													<div class="panel-heading">
														<div class="row">
															<div class="col-md-4"> 
															<a data-toggle="collapse" data-parent="#accordion1" href=".<?php echo " cour ".$cval22->id; ?>"><?php echo $cval22->product_name; ?>&nbsp;&nbsp;<i class="fa fa-caret-down"></i></a></div>
														...
														<div class="panel-body">
															...
															<div class="row">
																<div class="col-md-3">
																	<b>Included</b>
																	<p style="font-size: 12px;line-height: 20px;">
																		<?php echo $cval22->product_includes; ?>
																	</p>
																	<hr>
																	<b>Excluded</b>
																	<p style="font-size: 12px;line-height: 20px;">
																		<?php echo $cval22->product_excludes; ?>
																	</p>
																</div>
																<div class="col-md-3">
																	<b>Optional Services</b><br>
												...
												?>
													<div class="panel-collapse collapse <?php echo " pack ".$cval23->id; ?>" style="background-color:#ddd;">
														<div class="panel-body">
															...
															<p>
															<?php echo $cval23->product_description; ?>
															</p>
															<div class="row">
																<div class="col-md-3">
																	<b>Included</b>
																	<p style="font-size: 12px;line-height: 20px;">
																	<?php echo $cval23->product_includes; ?>
																	</p>
																	<hr>
																	<b>Excluded</b>
																	<p style="font-size: 12px;line-height: 20px;">
																	<?php echo $cval23->product_excludes; ?>
																	</p>
																</div>
																<div class="col-md-3">
																	<b>Optional Services</b><br>
