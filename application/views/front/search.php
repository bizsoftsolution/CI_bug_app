								...
								<!--#########jQuery_Date_Range_Picker##########-->
									<div class="row">
										...
										.form-control
										{
											...
											<div class="col-md-1" style="margin: 7px 0 0 28px;"><b>Dates</b></div>
											<div class="col-md-2">
											...
											<div class="col-md-1">&nbsp;</div>
											 <div class="col-md-2">
												<input type="submit" class="btn btn-default" value="Search" name="search_result" style="padding: 6px 30px;">
											 </div>
									</div>
