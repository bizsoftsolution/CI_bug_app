                  ...
                  <div class="col-md-9 col-sm-12 col-xs-12">
                     <div class="dashboard-main-disc">
                        <div class="heading-inner">
                           <p class="title">Welcome back, Raymond</p>
                        </div>
                        <div>
                           <p>You last login was on 20 Mar 2017, 5.51PM </p>
                           <p>You have 4 new messages. Click on <a href="" style="text-decoration:underline;">My MESSAGES</a> to check it out</p>
                           <p><a href="<?php echo base_url('Front/customerProfile'); ?>" style="text-decoration:underline;">VIEW MY PROFILE </a></p>
                           <p><a href="<?php echo base_url('Front/customereditProfile'); ?>" style="text-decoration:underline;">EDIT MY PROFILE</a></p>
                        </div>
                     </div>
                  </div>
