			...
			?>
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <a href="">
										<img src="<?php echo base_url(); ?>upload/DCpackage/<?php echo $cval24->photo; ?>" alt="Image" class="img-responsive" style="height:150px;width:250px;">
                                        </a>
                                    </div>
                                    <?php 
									}
                            ...
                            <!--div class="item">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <a href="#x"><img src="assert/images/1s.jpg" alt="Image" class="img-responsive" style="height:150px;width:250px;">
                                        </a>
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="#x"><img src="assert/images/2s.jpg" alt="Image" class="img-responsive" style="height:150px;width:250px;">
                                        </a>
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="#x"><img src="assert/images/3s.jpg" alt="Image" class="img-responsive" style="height:150px;width:250px;">
                                        </a>
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="#x"><img src="assert/images/4s.jpg" alt="Image" class="img-responsive" style="height:150px;width:250px;">
                                        </a>
                                    </div>
                                </div>
                                <!--/row->
                ...
                <div class="row">
						...
						<div class="row">
							...
							<div class="form-group"><span style="font-size:15px;width:100px;"><b><?php echo $divecenterval->dcname; ?></b></span></div>
							<div class="form-group">
...
// ]]></script>
		<div id="dvMap" style="width:420px; height: 100%;"></div>
			
              <div class="fixed affix-top" style="bottom:1px;">
