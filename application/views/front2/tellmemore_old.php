...
<body>
	...
	<div class="container-fluid">
		 <div class="col-md-6">
				  <h3>Overview</h3>
				  <p style="text-align: justify;font-family: initial;font-size: 17px;LINE-HEIGHT: 1.8;word-spacing: 1px;text-indent: 60px;">Tioman Island, or more fondly known by the locals as Pulau Tioman is a small island located in the state of Pahang in Peninsular Malaysia.

					It is along the east coast of the state which is one of the top tourist destinations in the region. In Tioman Island, there are 8 main villages in which Kampung Tekek has the highest population.</p>
				<table cellpadding="20" style="font-family: initial;font-size: 15px;LINE-HEIGHT: 1.8;word-spacing: 1px;">
					...
					<tr>
						...
						<td>Range From 27/80F to 30C/86F</td>
					</tr>
					<tr>
						<td><b>Under water Visibility</b></td>
						<td>Range betweeen 5m- 30m/16-98ft, depending on the reason</td>
					</tr>
					<tr>
						<td><b>Diving season</b></td>
						<td>Late january and lasts until middle of November</td>
					</tr>
				</table>
				  </div>
				  <div class="col-md-6">
