	...
	<fieldset title="2">
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
			...
			<div class="col-md-9">
			   <input name="product_price" class="form-control" type="text" required="" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="product_price">
			   <span class="help-block"></span>
			</div>
		 </div>
		 <div class="form-group">
